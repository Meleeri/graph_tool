    ...
    wxFrame(NULL, wxID_ANY, title, wxDefaultPosition, wxSize(800, 500))
{
    ...
    m_GLCanvas = new wxGLCanvas(this, wxID_ANY, (const int*)0, wxDefaultPosition, wxSize(500, 500), wxFULL_REPAINT_ON_RESIZE, wxT("GLCanvas")); 
    m_GLContext = new wxGLContext(m_GLCanvas);

    m_GLContext->SetCurrent(m_GLCanvas);
    m_GLCanvas->SwapBuffers();

    m_SizerRight->Add(m_GLCanvas, 1, wxEXPAND, 0);
